...
Begin Window Window_EGSnrc_Inputs
   ...
   Begin Label StaticText7
      ...
      TextAlignment   =   0
      TextColor       =   &c00000000
      Tooltip         =   "ESTEPE is the maximum fractional energy loss per electron step. For accurate electron \rtransport with default EGSnrc electron step algorithm, ESTEPE should not exceed 0.25 (the \rdefault). The value of ESTEPE should not be changed unless PRESTA-I is being used as the \relectron transport algorithm."
      Top             =   47
      Transparent     =   False
      Underline       =   False
      Visible         =   True
