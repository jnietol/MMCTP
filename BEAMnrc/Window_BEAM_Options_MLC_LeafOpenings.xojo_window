#tag Window
Begin Window Window_BEAM_Options_MLC_LeafOpenings
   Backdrop        =   0
...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  //Listbox_Openings.ColumnType(1)=3
		  Listbox_Openings.ColumnType(2)=3
		  Listbox_Openings.ColumnType(3)=3
		  
		  
		  MLC=Window_BEAM_Options_MLC.MLC
...
#tag Events PushButto_Close
	#tag Event
		Sub Action()
		  Window_BEAM_Options_MLC_LeafOpenings.Close
		End Sub
	#tag EndEvent
#tag EndEvents
#tag ViewBehavior
