#tag Window
Begin Window Window_BEAM_Options_MLC
   Backdrop        =   0
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub Refresh_window()
		  ...
		  if MLC.IDMLFC_MLC=0 Then
		    RadioButton_par_y.Value=True
		  Elseif MLC.IDMLFC_MLC=1 Then
...
#tag Events EditField_Pcut_Inside
	#tag Event
		Sub TextChange()
		  MLC.Pcut_inside_collimator=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_DoseZone_Inside
	#tag Event
		Sub TextChange()
		  MLC.Dose_Zone_inside_collimator=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_Latch_Inside
	#tag Event
		Sub TextChange()
		  MLC.IRegion_to_bit_inside_collimator=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_Mat_Inside
	#tag Event
		Sub TextChange()
		  MLC.Med_inside_collimator=Trim(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_Ecut_leaves
	#tag Event
		Sub TextChange()
		  MLC.Ecut_collimator_leaves=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_Pcut_leaves
	#tag Event
		Sub TextChange()
		  MLC.Pcut_collimator_Leaves=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_dose_zone_leaves
	#tag Event
		Sub TextChange()
		  MLC.Dose_Zone_collimator_Leaves=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_latch_leaves
	#tag Event
		Sub TextChange()
		  MLC.IRegion_to_bit_collimator_Leaves=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_material_leaves
	#tag Event
		Sub TextChange()
		  MLC.Med_collimator_leaves=Trim(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
