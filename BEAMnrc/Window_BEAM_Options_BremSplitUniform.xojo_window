#tag Window
Begin Window Window_BEAM_Options_BremSplitUniform
   Backdrop        =   0
...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  PopupMenu1.AddRow "Off"
		  PopupMenu1.AddRow "On"
	...
	#tag Event
		Sub Action()
		  if PopupMenu1.ListIndex=0 Then
		    ...
		    Window_BEAM_MainInputs.BEAM.IRRLTT=2
		    
		  end
		  
		  
		  Window_BEAM_Options_BremSplitUniform.Close
