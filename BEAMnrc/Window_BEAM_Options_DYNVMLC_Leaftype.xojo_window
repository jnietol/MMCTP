#tag Window
Begin Window Window_BEAM_Options_DYNVMLC_Leaftype
   Backdrop        =   0
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub RefreshList()
		  ...
		  Listbox_Type.ColumnType(2)=2
		  Listbox_Type.ColumnType(3)=2
		  ...
		  for i=0 to DVMLC.NGROUP_DYNVMLC-1
		    ...
		    elseif DVMLC.Groups(i).Leaftype=2 Then
		      Listbox_Type.CellCheck(i,3)=True
		    end
...
#tag Events PushButton1
	#tag Event
		Sub Action()
		  Window_BEAM_Options_DYNVMLC_Leaftype.Close
		End Sub
	#tag EndEvent
#tag EndEvents
#tag ViewBehavior
