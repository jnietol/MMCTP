...
Begin Window Window_DOSXYZ_Maininputs_source1
   ...
   Begin PushButton PushButton_Close
      ...
      Width           =   80
   End
   Begin TextField EditField_xcol
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
   ...
   Begin TextField EditField_Isocenter
      ...
      Width           =   257
   End
   Begin TextField EditField_Angles
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin Label StaticText12
      ...
      Width           =   208
   End
   Begin RadioButton RadioButton_MonEn
      AllowAutoDeactivate=   True
      Bold            =   False
   ...
   Begin Label StaticText20
      ...
      Width           =   208
   End
   Begin TextField EditField_y_col
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin TextField EditField_Spectrum
      ...
      Width           =   257
   End
   Begin RadioButton RadioButton_Spectrum
      AllowAutoDeactivate=   True
      Bold            =   False
      Caption         =   "spectrum"
      Enabled         =   True
	...
	#tag Event
		Sub Open()
		  ...
		  if dosxyz_input.enflag=0 Then
		    RadioButton_MonEn.Value=True
		  elseif dosxyz_input.enflag=1 Then
		    RadioButton_Spectrum.Value=True
...
#tag Events PushButton_Close
	#tag Event
		Sub Action()
		  Window_DOSXYZ_Maininputs_source1.Close
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_xcol
	#tag Event
		Sub TextChange()
		  dosxyz_input.xcol=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events RadioButton_MonEn
	#tag Event
		Sub Action()
		  if me.Value Then
		    dosxyz_input.enflag=0
...
#tag Events EditField_Energy
	...
	#tag EndEvent
#tag EndEvents
#tag Events EditField_y_col
	#tag Event
		Sub TextChange()
		  dosxyz_input.ycol=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_Spectrum
	...
	#tag EndEvent
#tag EndEvents
#tag Events RadioButton_Spectrum
	#tag Event
		Sub Action()
		  if me.Value Then
