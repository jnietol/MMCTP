#tag Window
Begin Window Window_DOSXYZ_Maininputs_source11
   Backdrop        =   0
   ...
   Begin Label StaticText2
      ...
      Width           =   253
   End
   Begin TextField EditField_distance_source
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin Label StaticText7
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Distance from souce to isocenter"
      TextAlignment   =   0
      TextColor       =   &c00000000
      Tooltip         =   ""
      Top             =   265
   ...
   Begin Label StaticText10
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Angles Tomo theta, phi, coll "
      TextAlignment   =   0
      TextColor       =   &c00000000
      Tooltip         =   ""
      Top             =   184
   ...
   Begin TextField EditField_theta
      ...
      Width           =   76
   End
   Begin TextField EditField_phicol
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin Label StaticText12
      ...
      Width           =   253
   End
   Begin TextField EditField_pitch
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  EditField_phicol.Text=Format(dosxyz_input.phicol(0),"-#.###")
		  ...
		  EditField_path.Text=dosxyz_input.path11
		  
		  EditField_ipp.Text=Format(dosxyz_input.tomo_ipp,"-#.####")
		  EditField_pitch.Text=Format(dosxyz_input.tomo_pitch,"-#.####")
...
#tag Events PushButton_Close
	#tag Event
		Sub Action()
		  Window_DOSXYZ_Maininputs_source11.Close
		End Sub
	#tag EndEvent
#tag EndEvents
...
#tag Events EditField_BEAM_exe
	...
	#tag EndEvent
#tag EndEvents
#tag Events EditField_distance_source
	#tag Event
		Sub TextChange()
...
#tag Events PopupMenu_LatchBitFilter
	...
	#tag EndEvent
#tag EndEvents
#tag Events EditField_ipp
	#tag Event
		Sub TextChange()
		  dosxyz_input.tomo_ipp=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_pitch
	#tag Event
		Sub TextChange()
		  dosxyz_input.tomo_pitch=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_path
	#tag Event
		Sub TextChange()
		  dosxyz_input.path11=Trim(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
