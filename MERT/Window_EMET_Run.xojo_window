   ...
   Begin TabPanel TabPanel_Lowers
      ...
      Begin GroupBox GroupBox11
         ...
         Begin Label StaticText80
            ...
            TextAlignment   =   0
            TextColor       =   &c00000000
            Tooltip         =   "RangeWeight=(RangeWeight0)*exp(-(MDeterministic)/GaussianRate);	\r\rRangebeam=(Rangebeam0)*exp(-(MDeterministic)/GaussianRate);		\r\r\rHigher GaussianRate means slower decrease in range\rLower GaussianRate means faster decrease in range"
            Top             =   182
            Transparent     =   False
            Underline       =   False
            Visible         =   True
         ...
         Begin Label StaticText81
            ...
            TextAlignment   =   0
            TextColor       =   &c00000000
            Tooltip         =   "Stochastic probability decrease rate\r\rSprobability = Sprobability*P-DecreaseRate;\r\r\rP - Decrease Rate : Larger Rate = Slower Decrease\rP - Decrease Rate : Smaller Rate = Faster Decrease"
            Top             =   207
            Transparent     =   False
            Underline       =   False
            Visible         =   True
         ...
         Begin Label StaticText83
            ...
            TextAlignment   =   0
            TextColor       =   &c00000000
            Tooltip         =   "PA: Probability of accepting a new solution\r\rOld formula\rPA=Bprobability/delta;\r\rCurrent formula \rPA=exp(Cost_F_Difference*beta)\rbeta=1/Sprobability;\rSprobability = Sprobability*DecreaseRate;"
            Top             =   233
            Transparent     =   False
            Underline       =   False
            Visible         =   True
      ...
      Begin GroupBox GroupBox13
         ...
         Begin Label StaticText43
            ...
            TextAlignment   =   0
            TextColor       =   &c00000000
            Tooltip         =   "beta = 1/ temp;\r\rdelta = CurObj - Obj;	// Delta < 0.0\r			//printf(""Delat : %e,\\n"",delta);\r\rPA = exp(delta * beta);"
            Top             =   333
            Transparent     =   False
            Underline       =   False
            Visible         =   True
      ...
      Begin GroupBox GroupBox16
         ...
         Begin RadioButton RadioButton_Jaw_Gaussian
            ...
            TabPanelIndex   =   4
            TabStop         =   True
            Tooltip         =   "Generating Gaussian Random Numbers\r\ry1 = sqrt( - 2 ln(x1) ) cos( 2 pi x2 )\ry2 = sqrt( - 2 ln(x1) ) sin( 2 pi x2 )"
            Top             =   123
            Transparent     =   False
            Underline       =   False
            Value           =   False
         ...
         Begin RadioButton RadioButton_JAW_Uniform
            ...
            TabPanelIndex   =   4
            TabStop         =   True
            Tooltip         =   "z=1;\rr1 = ((double) rand()) / ((double) RAND_MAX);\rif (r1<0.5)\r{\r	z=-1;\r}\r\rx = (z*Range);\r//printf(""x = %e\\n "",x);\rPB.weight[i] = CurWgt[i] + x;\r"
            Top             =   153
            Transparent     =   False
            Underline       =   False
            Value           =   False
         ...
         Begin RadioButton RadioButton_Jaw_Polar
            ...
            TabPanelIndex   =   4
            TabStop         =   True
            Tooltip         =   "float x1, x2, w, y1, y2;\r \rdo {\r  x1 = 2.0 * ranf() - 1.0;\r   x2 = 2.0 * ranf() - 1.0;\r   w = x1 * x1 + x2 * x2;\r} while ( w >= 1.0 );\r\rw = sqrt( (-2.0 * ln( w ) ) / w );\ry1 = x1 * w;\ry2 = x2 * w;"
            Top             =   69
            Transparent     =   False
            Underline       =   False
            Value           =   False
      ...
      Begin GroupBox GroupBox28
         ...
         Begin CheckBox CheckBox_Remove_Delete
            ...
            TabPanelIndex   =   1
            TabStop         =   True
            Tooltip         =   "Delete fields with Grad weights equal to zeros"
            Top             =   704
            Transparent     =   False
            Underline       =   False
            Value           =   False
