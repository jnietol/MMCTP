#tag Window
Begin Window Window_Profile_Properties
   Backdrop        =   0
   ...
   Begin TabPanel TabPanel1
      ...
      Scope           =   0
      SmallTabs       =   False
      TabDefinition   =   "Fields\rProperties of curve\rRaw Data"
      TabIndex        =   21
      TabPanelIndex   =   0
      TabStop         =   True
      Tooltip         =   ""
      ...
      Begin Label StaticText6
         ...
         Width           =   100
      End
      Begin TextField EditField_Linacname
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
      ...
      Begin GroupBox GroupBox2
         ...
         Visible         =   True
         Width           =   407
         Begin RadioButton RadioButton_Type_1
            AllowAutoDeactivate=   True
            Bold            =   False
            Caption         =   "PDD"
            Enabled         =   True
            ...
            Width           =   67
         End
         Begin RadioButton RadioButton_Type_0
            AllowAutoDeactivate=   True
            Bold            =   False
            Caption         =   "User"
            Enabled         =   True
            ...
            Width           =   73
         End
         Begin RadioButton RadioButton_Type_2
            AllowAutoDeactivate=   True
            Bold            =   False
            Caption         =   "Profile X"
            Enabled         =   True
            ...
            Width           =   83
         End
         Begin RadioButton RadioButton_Type_3
            AllowAutoDeactivate=   True
            Bold            =   False
            Caption         =   "Profile Y"
            Enabled         =   True
      ...
      Begin Label StaticText9
         ...
         Width           =   100
      End
      Begin TextField EditField_Label
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub Open_Pro()
		  ...
		  elseif one.TYPE=1 Then
		    RadioButton_Type_1.Value=True
		  elseif one.TYPE=2 Then
		    RadioButton_Type_2.Value=True
		  elseif one.TYPE=3 Then
		    RadioButton_Type_3.Value=True
		  end
	...
	#tag Method, Flags = &h0
		Sub Pop_Listbox()
		  ...
		  dim x_value,dx,dy,dz,a,b,sym1,sym2,sym3,sym4 as Single
		  //------------------------------------------
	...
	#tag Method, Flags = &h0
		Sub Pop_Listbox_Data()
		  //------------------------------------------
		  // List point values
		  //
		  //------------------------------------------
		  dim i,k,count as integer
		  dim x_value,dx,dy,dz,a,b,sym as Single
		  //------------------------------------------
...
#tag Events EditField_FieldY
	#tag Event
		Sub TextChange()
		  One.Field_Y=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_Linacname
	#tag Event
		Sub TextChange()
		  one.Linac=me.Text
		End Sub
...
#tag Events EditField_FieldX
	#tag Event
		Sub TextChange()
		  One.Field_X=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_Date
	#tag Event
		Sub TextChange()
		  One.Date=me.Text
		End Sub
...
#tag Events EditField_Label
	...
	#tag EndEvent
#tag EndEvents
#tag Events EditField_Algorithm
	#tag Event
		Sub TextChange()
		  One.Algorithm=(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
...
#tag Events PushButton_Apply
	#tag Event
		Sub Action()
		  ...
		  for i=0 to UBound(One.Points)
		    one.Points(i).x_cm=one.Points(i).X_cm+x
		    One.Points(i).y_cm=one.Points(i).Y_cm+y
		    One.Points(i).z_cm=one.Points(i).Z_cm+z
		  next
