...
#tag Events EditField_CT_Name
	...
	#tag EndEvent
#tag EndEvents
#tag Events EditField_CT_Pegs
	#tag Event
		Sub TextChange()
		  if DoNothing=False Then
		    
		    CT_Model.Pegs_file=me.Text
		    Save_Model=True
		  end
		End Sub
	#tag EndEvent
...
#tag Events Listbox_CT_Materials
	...
	#tag EndEvent
#tag EndEvents
#tag Events BevelButton_DelModel
	#tag Event
		Sub Action()
		  DIm i as Integer
...
#tag Events PushButton1
	#tag Event
		Sub Action()
		  Window_Configurations_CTModels.Close
		End Sub
	#tag EndEvent
#tag EndEvents
#tag ViewBehavior
